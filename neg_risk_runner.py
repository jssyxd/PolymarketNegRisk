...
def main() -> None:
    ...
    parser.add_argument("--min-profit-pct", type=float, default=1.5, help="Min arb net profit % hurdle (default: 1.5% positive EV)")
    parser.add_argument("--target-spread", type=float, default=0.03, help="Target maker spread in cents (default: 0.03)")
